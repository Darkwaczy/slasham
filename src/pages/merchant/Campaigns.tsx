      ...
      await apiClient("/merchants/campaigns", {
        ...
        body: JSON.stringify({
          ...
          discount_price: parseFloat(
            (formData.get('discountPrice') as string).replace(/[^0-9.]/g, '') || (formData.get('originalPrice') as string).replace(/[^0-9.]/g, '')
          ),
        ...
        <form onSubmit={handleSubmit} className="space-y-6 pt-6 mb-8 overflow-y-auto max-h-[70vh] px-2 text-sm">
          <div className="space-y-4">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 px-1">Suggested Slasham Discount Price</label>
                    <div className="relative">
