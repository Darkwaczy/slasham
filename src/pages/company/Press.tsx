      ...
      <section className="relative pt-32 lg:pt-48 px-6 lg:px-12 mb-24 max-w-[1800px] mx-auto text-left">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-20">
            ...
            >
                ...
                >
                    <img 
                        src="/C:/Users/DELL/.gemini/antigravity/brain/54298c44-8217-4b17-a52b-3e80fce7f319/press_hero_visual_1775385596611.png" 
                        alt="Press Visual" 
                        className="w-full h-auto drop-shadow-[0_35px_35px_rgba(79,70,229,0.1)] rounded-[4rem]"
                    />
                </motion.div>
